...
<script setup>
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/saicms/news/article/save'] },
    edit: { show: true, api: api.update, auth: ['/saicms/news/article/update'] },
    delete: { show: true, api: api.delete, auth: ['/saicms/news/article/destroy'], realApi: api.realDestroy, realAuth: ['/saicms/news/article/realDestroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/saicms/news/article/recovery']},
