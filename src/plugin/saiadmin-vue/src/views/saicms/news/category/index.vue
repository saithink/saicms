...
<script setup>
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/saicms/news/category/save'] },
    edit: { show: true, api: api.update, auth: ['/saicms/news/category/update'] },
    delete: { show: true, api: api.delete, auth: ['/saicms/news/category/destroy'], realApi: api.realDestroy, realAuth: ['/saicms/news/category/realDestroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/saicms/news/category/recovery']},
  ...
  const columns = reactive([
    ...
    },
    {
      ...
      formType: 'treeSelect',
      addDefaultValue: 0,
      dict: { url: '/saicms/news/category/index?tree=true' },
